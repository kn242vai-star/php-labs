...
my_sin($x)      = <?= is_string($results[0]['value']) ? $results[0]['value'] : round($results[0]['value'], 4) . "\n" ?>
my_cos($x)      = <?= is_string($results[1]['value']) ? $results[1]['value'] : round($results[1]['value'], 4) . "\n" ?>
my_tan($x)      = <?= is_string($results[2]['value']) ? $results[2]['value'] : round($results[2]['value'], 4) . "\n" ?>
