 ...
 *
 * Варіант 3 (група C, Sub3): пароль без підрядка логіну (>= 8 символів)
 * Довжина: 8
 */
...
/**
 * Генерує пароль, що не містить підрядка логіну (>= 8 символів)
 */
...
/**
 * Перевіряє чи пароль містить підрядок логіну (>= 8 символів)
 */
function containsLoginSubstring(string $password, string $login, int $minLength = 8): bool
{
...
<div class="demo-card demo-card-wide">
    ...
    <p class="demo-subtitle">Пароль не повинен містити підрядок логіну (>= 8 символів)</p>
...
// containsLoginSubstring(password, login, minLength: 8)
