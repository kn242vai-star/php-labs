...
<form method="POST" action="index.php?route=regform/form" class="form" novalidate>
    ...
    <div class="form__group <?= isset($errors['dob_day']) || isset($errors['dob_month']) || isset($errors['dob_year']) ? 'form__group--error' : '' ?>">
        <label class="form__label">Дата народження <span class="required">*</span></label>
        <div class="form__row">
            <input type="text" name="dob_day" class="form__input form__input--small"
                   value="<?= htmlspecialchars($old['dob_day'] ?? '') ?>" placeholder="ДД">
            <input type="text" name="dob_month" class="form__input form__input--small"
                   value="<?= htmlspecialchars($old['dob_month'] ?? '') ?>" placeholder="ММ">
            <input type="text" name="dob_year" class="form__input form__input--small"
                   value="<?= htmlspecialchars($old['dob_year'] ?? '') ?>" placeholder="РРРР">
        </div>
        <?php if (isset($errors['dob_day'])): ?>
            <span class="form__error"><?= htmlspecialchars($errors['dob_day']) ?></span>
        <?php elseif (isset($errors['dob_month'])): ?>
            <span class="form__error"><?= htmlspecialchars($errors['dob_month']) ?></span>
        <?php elseif (isset($errors['dob_year'])): ?>
            <span class="form__error"><?= htmlspecialchars($errors['dob_year']) ?></span>
        <?php endif; ?>
    </div>
